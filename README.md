...
Install the published `meco-core 0.5.1` crate:
...
Download packages from the [v0.5.1 release](https://github.com/Satsrag/meco-rust/releases/tag/v0.5.1).
...
| Browser/WebAssembly | `meco-wasm-web-0.5.1.tgz` |
