...
Install the published `meco-core 0.4.5` crate:

```sh
cargo install meco-core --version 0.4.5 --locked
```
...
Download packages from the [v0.4.5 release](https://github.com/Satsrag/meco-rust/releases/tag/v0.4.5).
...
| Browser/WebAssembly | `meco-wasm-web-0.4.5.tgz` |
| Node.js/WebAssembly | `meco-wasm-nodejs-0.4.5.tgz` |
