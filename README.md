...
Install the published `meco-core 0.4.0` crate:
...
Download packages from the [v0.4.0 release](https://github.com/Satsrag/meco-rust/releases/tag/v0.4.0).
...
| Browser/WebAssembly | `meco-wasm-web-0.4.0.tgz` |
