...
|---|---|---|
| **Desktop / server CLI** | `cargo install meco-core --version 0.4.7 --locked` | `meco-core` binary + library |
...
| **Android** (Gradle) | `implementation("com.zvvnmod:meco-android:0.4.7")` | `meco-uniffi` (Kotlin) |
