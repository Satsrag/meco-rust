...
|---|---|---|
| **Desktop / server CLI** | `cargo install meco-core --version 0.4.8 --locked` | `meco-core` binary + library |
...
| **Android** (Gradle) | `implementation("com.zvvnmod:meco-android:0.4.8")` | `meco-uniffi` (Kotlin) |
