...
|---|---|---|
| **Desktop / server CLI** | `cargo install meco-core --version 0.5.0 --locked` | `meco-core` binary + library |
...
| **Android** (Gradle) | `implementation("com.zvvnmod:meco-android:0.5.0")` | `meco-uniffi` (Kotlin) |
