...
|---|---|---|
| **Desktop / server CLI** | `cargo install meco-core --version 0.5.1 --locked` | `meco-core` binary + library |
...
| **Android** (Gradle) | `implementation("com.zvvnmod:meco-android:0.5.1")` | `meco-uniffi` (Kotlin) |
