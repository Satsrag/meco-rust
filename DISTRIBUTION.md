...
|---|---|---|
| **Desktop / server CLI** | `cargo install meco-core --version 0.4.5 --locked` | `meco-core` binary + library |
...
| **Android** (Gradle) | `implementation("com.zvvnmod:meco-android:0.4.5")` | `meco-uniffi` (Kotlin) |
