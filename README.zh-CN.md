...
从 crates.io 安装已经发布的 `meco-core 0.5.1`：
...
从 [v0.5.1 Release](https://github.com/Satsrag/meco-rust/releases/tag/v0.5.1) 下载。
...
| 浏览器/WebAssembly | `meco-wasm-web-0.5.1.tgz` |
| Node.js/WebAssembly | `meco-wasm-nodejs-0.5.1.tgz` |
